...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Nombre real desplegado en Supabase: "rapid-endpoint" (el dashboard le
    // puso ese nombre al crearla, no "yappy-ipn"). Si algún día la vuelves a
    // desplegar y le queda otro nombre, actualiza esta línea también.
    const ipnUrl = `${SUPABASE_URL}/functions/v1/rapid-endpoint`;
